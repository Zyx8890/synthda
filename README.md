...
### See our wiki pages for the full [set up instructions]([https://github.com/NVIDIA/synthda/wiki/Setting-Up-SynthDa](https://github.com/NVIDIA/synthda/wiki/1.-Setting-Up-SynthDa)) and [customization options]([https://github.com/NVIDIA/synthda/wiki](https://github.com/NVIDIA/synthda/wiki/2.-Customizing-SynthDa)) 
